...
const Expandable = React.forwardRef<HTMLDivElement, ExpandableProps>(
  (
    ...
    const contextValue: ExpandableContextType = {
      isExpanded,
      toggleExpand,
      expandDirection: expandDirection as "vertical" | "horizontal" | "both",
      expandBehavior: expandBehavior as "replace" | "push",
      transitionDuration,
      easeType,
      initialDelay,
      onExpandEnd,
    ...
    return (
      <motion.div
        ...
        style={{
          ...
          width:
            expandDirection === "vertical" ? undefined : smoothWidth,
          height:
